                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <select style="margin-bottom: 10px;" name="classname" required="required" class="form-control" id="success">
                                                                <option value="ND">ND</option>
                                                                <option value="HND">HND</option>
                                                            </select>
                                                            <span class="help-block">Eg- ND or HND</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <select style="margin-bottom: 10px;" name="classnamenumeric" required="required" class="form-control" id="success">
                                                    ...
                                                    <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- 2020/2021</span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group has-success">
