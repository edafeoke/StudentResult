                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post">
                                                ...
                                                <div class="form-group">
                                                    <label for="default" class="col-sm-2 control-label">Mat Number</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" name="rollid" class="form-control" id="rollid" maxlength="17" required="required" autocomplete="off">
                                                    </div>
                                                </div>
                                                        ...
                                                        <select name="class" class="form-control" id="default" required="required">
                                                            ...
                                                            if ($query->rowCount() > 0) {
                                                                foreach ($results as $result) {   ?>
                                                                    <option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassName); echo htmlentities($result->ClassNameNumeric); ?>&nbsp; Section-<?php echo htmlentities($result->Section); ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
